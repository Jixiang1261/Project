...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM labuan";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Labuan</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getlabuan.html"><h2>Insert new data</h2></a>
   <a href="labuandate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Labuan:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [146, 131, 83, 72, 87, 72, 93];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Labuan:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [2, 5, 3, 2, 4, 8, 4];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Labuan:"
 }}});
