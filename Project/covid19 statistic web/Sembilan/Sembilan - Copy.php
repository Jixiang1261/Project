...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM sembilan";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Negeri Sembilan</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getsembilan.html"><h2>Insert new data</h2></a>
   <a href="sembilandate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Negeri Sembilan:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [1968, 1882, 1502, 1405, 885, 595, 1061];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Negeri Sembilan:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [99, 105, 96, 104, 75, 55, 87];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Negeri Sembilan:"
 }}});
