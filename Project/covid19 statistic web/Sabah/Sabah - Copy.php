...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM sabah";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Sabah</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getsabah.html"><h2>Insert new data</h2></a>
   <a href="sabahdate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Sabah:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [708, 769, 596, 421, 339, 416, 402];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Sabah:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [124, 107, 96, 101, 61, 77, 93];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Sabah:"
 }}});
