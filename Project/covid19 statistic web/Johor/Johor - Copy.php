...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM johor";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Johor</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getjohor.html"><h2>Insert new data</h2></a>
   <a href="johordate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  var yValues = [11, 10, 14, 11, 10, 2, 0];
  var barColors = "red";
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Johor:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [2577, 1990, 1624, 1286, 1441, 1088, 927];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Johor:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [298, 313, 317, 249, 255, 297, 270];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Johor:"
 }}});
