...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM pinang";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Pulau Pinang</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getpinang.html"><h2>Insert new data</h2></a>
   <a href="pinangdate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Pulau Pinang:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [2441, 2315, 2306, 1928, 1772, 1310, 1295];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Pulau Pinang:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [157, 173, 142, 136, 135, 128, 112];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Pulau Pinang:"
 }}});
