...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM putrajaya";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Putrajaya</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getputrajaya.html"><h2>Insert new data</h2></a>
   <a href="putrajayadate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Putrajaya:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [180, 150, 142, 128, 133, 100, 65];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Putrajaya:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [39, 42, 57, 36, 30, 43, 28];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Putrajaya:"
 }}});
