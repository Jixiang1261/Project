...
<body>
   <?php
	...
	//select all
   $query = "SELECT * FROM kl";
   
   	if(!($result = mysqli_query($cont, $query))){
		  echo("Failed to run command");
	}
	echo "<h1>The Status of Kuala Lumpur</h1>";
		echo "<table>";
		echo "<tr>
   ...
   <a href="getkl.html"><h2>Insert new data</h2></a>
   <a href="kldate.html"><h2>Delete a data</h2></a>
...
<script>
  ...
  new Chart("myChart", {
    ...
    title: {display: true,
     text: "Death Cases in Kuala Lumpur:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [3565, 3266, 2757, 3078, 1659, 1433, 3433];
  var barColors = "blue";
  ...
  new Chart("myChart1", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Confirmed Cases in Kuala Lumpur:"
 }}});

  var xValues = ["2022-03-16", "2022-03-17", "2022-03-18", "2022-03-19", "2022-03-20", "2022-03-21", "2022-03-22"];
  var yValues = [120, 112, 120, 125, 77, 91, 115];
  var barColors = "green";
  ...
  new Chart("myChart2", {
    ...
    legend: {display: false},
    title: {display: true,
     text: "Hospital Admission in Kuala Lumpur:"
 }}});
