...
if(!$_SESSION['name1']) {
    ...
    exit();
     ...
     $read9 = "SELECT * FROM computers WHERE computername = 'cm11' ORDER BY date, SUBSTRING(stime, -2), stime";
...
<div class="container">
<div class = "box">
<form method="post" action="adcm11.php" name= "addform" id="add_form">
    ...
    <input type="comname" name="comname" value = "cm11" placeholder="comname" hidden>
...
<div class = "box">
<form method="post" action="adcm11.php" name= "createform" id="create_form">
    ...
    <div <?php if (isset($time2_error)): ?> class="form_error" <?php endif ?> >
  		<input type="number"  placeholder="First Reservation Time" name="time3" min="0" max="23" required>
		<?php if (isset($time2_error)): ?>
      	<span><?php echo $time2_error; ?></span>
      <?php endif ?>
  	</div>
...
<div class = "box">
<form method="post" action="adcm11.php" name= "dform" id="d_form">
...
<div class = "box">
<form method="post" action="adcm11.php" name= "d2form" id="d2_form">
