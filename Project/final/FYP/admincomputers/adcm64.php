...
if(!$_SESSION['name1']) {
    ...
    exit();
     ...
     $read9 = "SELECT * FROM computers WHERE computername = 'cm64' ORDER BY date, SUBSTRING(stime, -2), stime";
...
<div class="container">
<div class = "box">
<form method="post" action="adcm64.php" name= "addform" id="add_form">
    ...
    <input type="comname" name="comname" value = "cm64" placeholder="comname" hidden>
...
<div class = "box">
<form method="post" action="adcm64.php" name= "createform" id="create_form">
...
<div class = "box">
<form method="post" action="adcm64.php" name= "dform" id="d_form">
...
<div class = "box">
<form method="post" action="adcm64.php" name= "d2form" id="d2_form">
