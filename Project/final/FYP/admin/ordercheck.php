...
<?php
  ...
  if (isset($_POST['ordercheck'])) {
    ...
    if (mysqli_num_rows($runoc) > 0){
        echo "<div class = 'bbox'>
            <div class = 'container'>
            <form method='post' action='ordercheck.php' name= 'finish_form' id='finish_form'>
            <h1>Are you Sure to Finish this Order?</h1>
            <input type='number' value='$orderid' placeholder='Order ID' name='orderid' hidden>
             <button type='submit' name='finish' id='finish_btn' value='finish' form='finish_form' >Finish</button>
            </div>
            </div>
    ...
    $order_wrong ="There is no Order exist with this ID";
