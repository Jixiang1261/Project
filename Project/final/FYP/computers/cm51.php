...
$userid = mysqli_query($db, $read4);  
     ...
     $read9 = "SELECT * FROM computers WHERE computername = 'cm51' ORDER BY date, stime";
...
<div class = "box">
<form method="post" action="cm51.php" name= "bookaform" id="book_form">
  	<h1>Book Reservation</h1>


    <?php echo "<input type='text' name='name' value='$username' hidden>";  ?>
    <input type='text' name='comname' value='cm51' hidden>
...
<div class = "box1">
<form method="post" action="cm51.php" name= "cancelform" id="cancel_form">
