...
void sortname()
{
 ...
 for(i=0;i<=num-1;i++)
  {
   for(j=0;j<=num-1;j++)
   {
    if(strcmp(cdsort1[i].name,cdsort1[j].name)<=0)
    {
     temp[i]=cdsort1[i];
     cdsort1[i]=cdsort1[j];
     cdsort1[j]=temp[i];
...

 {
  ...
  cout<<setw(13)<<cdsort1[i].name;

  cout<<setw(6)<<cdsort1[i].id;

  cout<<setw(15)<<cdsort1[i].category;

  cout<<setw(10)<<cdsort1[i].quantity;

  cout<<setw(15)<<cdsort1[i].price;
 ...
 for(i=0;i<=num-1;i++)
  {
   for(j=0;j<=num-1;j++)
   {
    if(strcmp(cdsort1[i].category,cdsort1[j].category)<=0)
    {
     temp[i]=cdsort1[i];
     cdsort1[i]=cdsort1[j];
     cdsort1[j]=temp[i];
 ...
 for(i=0;i<=num-1;i++)
  {
   for(j=0;j<=num-1;j++)
   {
    if(cdsort1[i].age<cdsort1[j].age)
    {
     temp[i]=cdsort1[i];
     cdsort1[i]=cdsort1[j];
     cdsort1[j]=temp[i];
 ...
 for(i=0;i<=num-1;i++)
  {
   for(j=0;j<=num-1;j++)
   {
    if(cdsort1[i].quantity<cdsort1[j].quantity)
    {
     temp[i]=cdsort1[i];
     cdsort1[i]=cdsort1[j];
     cdsort1[j]=temp[i];
